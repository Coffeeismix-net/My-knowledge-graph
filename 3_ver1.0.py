...
from modules.stock_ui import render_stock_page  # [NEW] 주식 페이지 모듈 불러오기
...
if not st.session_state['logged_in']:
    ...
    with main:
        ...
        if menu_cols[3].button("Stock", key="nav_stock", use_container_width=True): st.session_state['menu_mode'] = "Stock Analysis"; st.rerun()
        ...
        if st.session_state['menu_mode'] == "Knowledge Graph":
            ...
            render_stock_page()  # [NEW] 모듈 함수 호출
